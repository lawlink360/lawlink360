...
class AdminJudgmentsContentScreen extends ConsumerWidget {
  const AdminJudgmentsContentScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final judgmentContents = notifier.contents
        .where(
          (content) =>
              content.category.toLowerCase() == 'judgments',
        )
        .toList();

    return Scaffold(
      appBar: AdminAppBar(
        title: 'Judgments Content',
      ...
      body: state.when(
        ...
        data: (_) {
          if (judgmentContents.isEmpty) {
            return const Center(
              child: Text('No judgment content available.'),
            );
          }
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemCount: judgmentContents.length,
              itemBuilder: (context, index) {
                final content = judgmentContents[index];
