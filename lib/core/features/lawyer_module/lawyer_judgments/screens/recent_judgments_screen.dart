...
class RecentJudgmentsScreen extends ConsumerWidget {
  const RecentJudgmentsScreen({super.key});

  static const Color navy = Color(0xFF13294B);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final judgments = ref.watch(judgmentRecentProvider);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Judgments you open will appear here.',
